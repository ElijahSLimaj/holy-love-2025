...
class MockUsers {
  static List<UserProfile> get sampleProfiles => [
        ...
        UserProfile(
          ...
          bio:
              'Software engineer passionate about using technology for good. Love rock climbing, board games, and deep conversations about faith and life.',
          denomination: 'Presbyterian',
          churchAttendance: 'Weekly',
          favoriteVerse: 'Philippians 4:13',
          faithStory:
              'Came to faith in college and it completely transformed my perspective on life and relationships. Active in young adults ministry.',
          interests: [
            'Rock Climbing',
            'Board Games',
            'Programming',
        ...
        UserProfile(
          ...
          bio:
              'Worship pastor who loves leading people into God\'s presence. When not at church, you\'ll find me playing guitar, hiking, or trying new coffee shops.',
          denomination: 'Baptist',
          churchAttendance: 'Multiple times per week',
          favoriteVerse: 'Psalm 23:1',
          faithStory:
              'Been in ministry for 8 years. Looking for a partner who shares my passion for worship and serving God together.',
          interests: [
            'Worship Music',
            'Guitar',
            'Hiking',
        ...
        UserProfile(
          ...
          bio:
              'Physical therapist who believes in healing both body and soul. Love basketball, cooking, and mentoring young men at church. Ready for my Ruth! 🏀',
          denomination: 'Pentecostal',
          churchAttendance: 'Multiple times per week',
          favoriteVerse: 'Joshua 1:9',
          faithStory:
              'Named after Joshua in the Bible. My faith gives me strength to help others heal and overcome challenges.',
          interests: [
            'Basketball',
            'Cooking',
            'Mentoring',
        ...
        UserProfile(
          ...
          bio:
              'Youth pastor with a heart for the next generation. Love desert hikes, board games, and deep conversations about life and faith.',
          denomination: 'Assemblies of God',
          churchAttendance: 'Multiple times per week',
          favoriteVerse: '1 Timothy 4:12',
          faithStory:
              'Called to youth ministry in college. Love seeing young people discover their purpose in God.',
          interests: [
            'Youth Ministry',
            'Desert Hiking',
            'Board Games',
