...
class ProfileStepPreferencesState extends State<ProfileStepPreferences>
  ...
  final List<Map<String, dynamic>> _faithImportanceOptions = [
    ...
    },
    {
      'id': 'important',
      'name': 'Important',
      'description': 'Faith matters to me',
      'icon': '✨'
    },
    {
      'id': 'somewhat_important',
      'name': 'Somewhat Important',
      'description': 'Faith has some importance',
      'icon': '💫'
    },
    {
      'id': 'open_minded',
      'name': 'Open-minded',
      'description': 'Respectful of all beliefs',
      'icon': '🤝'
    },
  ];
  ...
  void _loadExistingData() {
    ...
    _selectedDealBreakers =
        List<String>.from(widget.profileData['dealBreakers'] ?? []);
  }
                  ...
                  builder: (context, child) {
                    return Opacity(
                      ...
                      child: Transform.scale(
                        scale: 0.8 +
                            (0.2 * _sliderAnimation.value.clamp(0.0, 1.0)),
                        child: SliderTheme(
